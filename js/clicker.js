...
let achievements = [
    {
        description: 'Nu har du en operation att mata familjer! ',
        requiredUpgrades: 1,
        acquired: false,
    },
    {
        description: 'Du har mättat 10 familjer! Fortsätt så!',
        requiredUpgrades: 10,
        acquired: false,
    },
    {
        description: 'Du matade en familj!',
        requiredClicks: 10,
        acquired: false,
    },
    {
        description: 'Ingen i Irak svälter längre! Bra jobbat!',
